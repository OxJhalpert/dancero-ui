...
function getTransformationHourPack(hours) {
  switch (hours) {
    case "10":
      return {
        'ipp': 0, 'dpp': 15, 'ipc': 0, 'dpc': 15, 'iap': 0, 'iac': 0
      };
    case "15":
      return {
        'ipp': 0, 'dpp': 20, 'ipc': 0, 'dpc': 15, 'iap': 0, 'iac': 0
      };
    case "20":
      return {
        'ipp': 0, 'dpp': 25, 'ipc': 0, 'dpc': 15, 'iap': 0, 'iac': 0
      };
    case "25":
      return {
        'ipp': 0, 'dpp': 27.5, 'ipc': 0, 'dpc': 15, 'iap': 0, 'iac': 0
      };
    case "30":
      return {
        'ipp': 0, 'dpp': 30, 'ipc': 0, 'dpc': 15, 'iap': 0, 'iac': 0
      };
    case "40":
      return {
        'ipp': 0, 'dpp': 32.5, 'ipc': 0, 'dpc': 15, 'iap': 0, 'iac': 0
      };
    case "50":
      return {
        'ipp': 0, 'dpp': 35, 'ipc': 0, 'dpc': 15, 'iap': 0, 'iac': 0
      };
    default:
      return {
...
function getLevelTransformation(level) {
  ...
  switch (level) {
    case "semi":
      return {
        'ipp': 0, 'dpp': 10, 'ipc': 0, 'dpc': 10, 'iap': 0, 'iac': 0
      };
    case "pro":
      return {
        'ipp': 0, 'dpp': 0, 'ipc': 0, 'dpc': 0, 'iap': 0, 'iac': 0
    ...
    case "master":
      return {
        'ipp': 20, 'dpp': 0, 'ipc': 10, 'dpc': 0, 'iap': 0, 'iac': 0
      };
    default:
      return {
        'ipp': 0, 'dpp': 0, 'ipc': 0, 'dpc': 0, 'iap': 0, 'iac': 0
...
function getServiceAmountTransformation(service) {
  ...
  switch (service) {
    ...
    case "standard":
      return {
        'ipp': 15, 'dpp': 0, 'ipc': 0, 'dpc': 0, 'iap': 0, 'iac': 0
      };
    case "premium":
      return {
        'ipp': 30, 'dpp': 0, 'ipc': 0, 'dpc': 0, 'iap': 0, 'iac': 0
      };
    default:
      return {
        'ipp': 0, 'dpp': 0, 'ipc': 0, 'dpc': 0, 'iap': 0, 'iac': 0
...
function getLocationTransformation(location, venue, place) {
  ...
  switch (option) {
    case "virtual":
      return {
        'ipp': 0, 'dpp': 25, 'ipc': 0, 'dpc': 30, 'iap': 0, 'iac': 0
      };
    case "medellinhome":
      return {
        'ipp': 0, 'dpp': 0, 'ipc': 0, 'dpc': 0, 'iap': 0, 'iac': 0
    ...
    case "medellinstudio":
      return {
        'ipp': 0, 'dpp': 0, 'ipc': 0, 'dpc': 0, 'iap': 15000, 'iac': 15000
      };
    case "bogotahome":
      return {
        'ipp': 20, 'dpp': 0, 'ipc': 20, 'dpc': 0, 'iap': 0, 'iac': 0
      };
    case "bogotastudio":
      return {
        'ipp': 20.0, 'dpp': 0, 'ipc': 20, 'dpc': 0, 'iap': 20000, 'iac': 20000
      };
    case "cartagenahome":
      return {
        'ipp': 10, 'dpp': 0, 'ipc': 10, 'dpc': 0, 'iap': 0, 'iac': 0
      };
    case "cartagenastudio":
      return {
        'ipp': 10, 'dpp': 0, 'ipc': 10, 'dpc': 0, 'iap': 30000, 'iac': 30000
      };
    case "calihome":
      return {
        'ipp': 0, 'dpp': 10, 'ipc': 0, 'dpc': 10, 'iap': 0, 'iac': 0
    ...
    case "calistudio":
      return {
        'ipp': 0, 'dpp': 10, 'ipc': 0, 'dpc': 10, 'iap': 10000, 'iac': 10000
      };
    default:
      return {
        'ipp': 0, 'dpp': 0, 'ipc': 0, 'dpc': 0, 'iap': 0, 'iac': 0
